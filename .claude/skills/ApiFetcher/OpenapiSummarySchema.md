...
```bash
python3 ~/.claude/skills/ApiFetcher/Tools/openapi_summary.py path/to/openapi.yaml
```

The script writes JSON to stdout. Capture it for processing:

```bash
python3 ~/.claude/skills/ApiFetcher/Tools/openapi_summary.py path/to/spec.yaml > /tmp/summary.json
```
...
2. Run: `python3 ~/.claude/skills/ApiFetcher/Tools/openapi_summary.py apidocs/source/spec.yaml`
