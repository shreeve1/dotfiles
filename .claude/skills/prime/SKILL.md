---
name: prime
description: Run a medium-depth codebase scan at the start of a new session to understand what the project does, how it is structured, and what to work on next. USE WHEN user wants session priming, project orientation, "prime the session", or initial codebase overview. NOT for mid-session use when context is already loaded.
---
