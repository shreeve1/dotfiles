...
**Night:** `~/.claude/PAI/Tools/ralph-loop.sh --limit 10`
...
```bash
~/.claude/PAI/Tools/ralph-loop.sh                # Run all unblocked AFK issues
~/.claude/PAI/Tools/ralph-loop.sh --limit 3      # Stop after 3 issues
~/.claude/PAI/Tools/ralph-loop.sh --dry-run       # Preview without running
~/.claude/PAI/Tools/ralph-loop.sh --review        # Review last completed issue
~/.claude/PAI/Tools/ralph-loop.sh --validate      # Validate board schema
~/.claude/PAI/Tools/ralph-loop.sh --stale         # Detect stale locks
```
