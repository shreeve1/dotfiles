...
Use when:
- Bug or unexpected behavior encountered
- Root cause location unclear
- Need to avoid guessing and ensure thorough investigation
...
- Note that `/test-CDT` or `/test-Playwright` user story execution can serve as verification gate
