---
name: dev-tool_check
description: Audit installed tools against a plan and find missing MCP servers, plugins, or CLI tools that would help complete it
argument-hint: [path/to/plan.md]
model: opus
disallowed-tools: Task, EnterPlanMode, Write, NotebookEdit
---
...
PLAN_DIRECTORIES: `artifacts/plans/`, `~/.claude/plans/`
...
2. If not provided, scan `PLAN_DIRECTORIES` for the most recently modified `.md` file. Use that as the plan.
