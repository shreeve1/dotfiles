...
Voice announcements are disabled. Do not call `localhost:8888/notify` during Algorithm entry or phase transitions.
...
**PRD stub (MANDATORY — immediately after loading this file):**
