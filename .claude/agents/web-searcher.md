...
1. **Analyze the query** - Understand what information the user is seeking (current events, documentation, news, general facts, etc.)

2. **Execute web search** - Use the WebSearch tool to find relevant, up-to-date information. Craft clear, specific search queries for best results.
...
4. **Synthesize findings** - Summarize the information concisely, focusing on:
   - Direct answers to the query
   - Key facts and data points
   - Current/recent information (check dates)
   - Multiple perspectives when relevant

5. **Cite sources** - Include the URLs of the sources you used for verification.
