...
6. For a big or wide change, run it as an `pstack-arena`. Ask several models the same question and merge the answers. Different models catch different real bugs.
