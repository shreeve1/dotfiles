---
name: question
description: Answer a question about the current project in read-only mode. USE WHEN user asks "how does X work", "where is Y", "what does Z do", or wants a project explanation without code changes. Do NOT modify any files.
---
