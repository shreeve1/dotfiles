...
- Multi-step / complex / debug / plan / build / multi-file → ALGORITHM → \`♻︎ Entering the PAI ALGORITHM… (v6.3.0) ═════════════\` then \`🗒️ TASK: [8 words]\`

ALGORITHM mandatory first action: use Read tool on \`~/.claude/PAI/Algorithm/v6.3.0.md\` and follow it exactly (phases, ISCs, ISA as system of record, reflection).
