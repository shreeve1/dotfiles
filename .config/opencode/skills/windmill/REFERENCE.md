...
Token stored in memory: `~/.pai/projects/-home-james-windmill/memory/windmill-api-key.md`

```bash
TOKEN=$(grep -oP 'V7Jz\w+' ~/.pai/projects/-home-james-windmill/memory/windmill-api-key.md | head -1)
