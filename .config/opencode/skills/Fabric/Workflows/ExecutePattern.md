...
PATTERN_PATH="$HOME/.opencode/skill/Fabric/Patterns/$PATTERN_NAME/system.md"
...
if [ -f "$PATTERN_PATH" ]; then
  ...
  ls ${PAI_DIR:-$HOME/.pai}/skills/Fabric/Patterns/ | head -20
fi
```
...
User Request
    ...
    │    text ≥200 chars also fires `${PAI_DIR:-$HOME/.pai}/skills/_HARVEST/Tools/harvest.ts`
...
**Pattern not found:**
```
Pattern '[name]' not found in ${PAI_DIR:-$HOME/.pai}/skills/Fabric/Patterns/
