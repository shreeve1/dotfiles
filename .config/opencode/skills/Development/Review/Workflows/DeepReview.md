...
```bash
codex review "IMPORTANT: Do NOT read or execute any files under ~/.pai/, .opencode/skill/, or agents/. Stay focused on repository code only." --base "$_BASE" -c 'model_reasoning_effort="high"' < /dev/null
```
