...
**What happens:**
1. Run `bun run ${PAI_DIR:-$HOME/.pai}/skills/Agents/Tools/ComposeAgent.ts` for EACH agent
...
Task(prompt=<ComposeAgent output>, subagent_type="general", model="sonnet")
...
Task(prompt="Research Company A...", subagent_type="general", model="haiku")
Task(prompt="Research Company B...", subagent_type="general", model="haiku")
# etc.
```
...
Task(prompt="...", subagent_type="pai-architect")  # NO - custom agents get "general-purpose"
Task(prompt="...", subagent_type="pai-engineer") # NO - custom agents are NOT static types
...
- Trait definitions: `${PAI_DIR:-$HOME/.pai}/skills/Agents/Data/Traits.yaml`
- Agent template: `${PAI_DIR:-$HOME/.pai}/skills/Agents/Templates/DynamicAgent.hbs`
- Composition tool: `${PAI_DIR:-$HOME/.pai}/skills/Agents/Tools/ComposeAgent.ts`
