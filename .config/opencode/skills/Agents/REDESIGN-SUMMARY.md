...
```
${PAI_DIR:-$HOME/.pai}/skills/Agents/
...
Old YAML system backed up to: `~/.pai/History/Backups/2025-12-18-AgentProfiles/`
...
bun run ${PAI_DIR:-$HOME/.pai}/skills/Agents/Tools/LoadAgentContext.ts
# Output: Architect, Artist, Engineer, Designer, QATester

# View specific context
bun run ${PAI_DIR:-$HOME/.pai}/skills/Agents/Tools/LoadAgentContext.ts Architect

# Generate enriched prompt
bun run ${PAI_DIR:-$HOME/.pai}/skills/Agents/Tools/LoadAgentContext.ts Engineer "Implement TDD workflow"
```
