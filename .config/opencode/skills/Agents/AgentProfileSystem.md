...
bun run ${PAI_DIR:-$HOME/.pai}/skills/Agents/Tools/LoadAgentContext.ts Architect "Design new skill system"
```
...
1. Create `[AgentType]Context.md` in `${PAI_DIR:-$HOME/.pai}/skills/Agents/`
