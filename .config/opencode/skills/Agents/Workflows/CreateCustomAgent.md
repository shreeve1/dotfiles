...
**CRITICAL: Use `subagent_type: "general"` - NEVER use static types like "Architect" or "Engineer" for custom agents.**
...
- ComposeAgent tool: `${PAI_DIR:-$HOME/.pai}/skills/Agents/Tools/ComposeAgent.ts`
- Voice mappings: `${PAI_DIR:-$HOME/.pai}/skills/Agents/AgentPersonalities.md`
