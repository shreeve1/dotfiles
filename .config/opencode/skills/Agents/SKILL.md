...
bun run ${PAI_DIR:-$HOME/.pai}/skills/Agents/Tools/ComposeAgent.ts --task "Review security"
bun run ${PAI_DIR:-$HOME/.pai}/skills/Agents/Tools/ComposeAgent.ts --traits "security,skeptical,thorough"

# Persistent custom agents
bun run ${PAI_DIR:-$HOME/.pai}/skills/Agents/Tools/ComposeAgent.ts --task "Security review" --save
bun run ${PAI_DIR:-$HOME/.pai}/skills/Agents/Tools/ComposeAgent.ts --list-saved
bun run ${PAI_DIR:-$HOME/.pai}/skills/Agents/Tools/ComposeAgent.ts --load "security-expert-skeptical-thorough"
bun run ${PAI_DIR:-$HOME/.pai}/skills/Agents/Tools/ComposeAgent.ts --delete "security-expert-skeptical-thorough"

# Other options
bun run ${PAI_DIR:-$HOME/.pai}/skills/Agents/Tools/ComposeAgent.ts --list
bun run ${PAI_DIR:-$HOME/.pai}/skills/Agents/Tools/ComposeAgent.ts --output json
```
