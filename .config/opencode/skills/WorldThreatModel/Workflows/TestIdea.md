...
- World models must exist at `~/.pai/PAI/MEMORY/RESEARCH/WorldModels/`
...
```
Check ~/.pai/PAI/MEMORY/RESEARCH/WorldModels/ for all 11 model files.
...
Read all 11 model files from `~/.pai/PAI/MEMORY/RESEARCH/WorldModels/`.
