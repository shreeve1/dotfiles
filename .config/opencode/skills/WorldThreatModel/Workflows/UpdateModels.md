...
- Model template at `${PAI_DIR:-$HOME/.pai}/skills/WorldThreatModel/ModelTemplate.md`
...
```
Read ~/.pai/PAI/MEMORY/RESEARCH/WorldModels/INDEX.md (if exists)
...
Save to: `~/.pai/PAI/MEMORY/RESEARCH/WorldModels/{horizon}.md`

### Step 5: Update INDEX

Write/update `~/.pai/PAI/MEMORY/RESEARCH/WorldModels/INDEX.md`:
