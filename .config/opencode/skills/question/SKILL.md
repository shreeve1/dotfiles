...
metadata:
  source: /Users/james/.pi/agent/skills/pi-question/SKILL.md
  original_name: pi-question
---

# Question

Converted from `/Users/james/.pi/agent/skills/pi-question/SKILL.md`. Imported as `question` for OpenCode.
...
If the question is ambiguous, use `question` to narrow the target before exploring.

## Phase 2 — Delegate Exploration

Use `task` in single mode with the `scout` agent to gather targeted, read-only findings.
