#!/usr/bin/env python3
"""
openapi_summary.py — ApiFetcher skill helper
Parses an OpenAPI/Swagger spec and emits a structured JSON summary
of resources and endpoints to stdout.

Usage:
    python3 ${PAI_DIR:-$HOME/.pai}/skills/ApiFetcher/Tools/openapi_summary.py <openapi.{json,yaml,yml}>
"""
import json
import re
import subprocess
