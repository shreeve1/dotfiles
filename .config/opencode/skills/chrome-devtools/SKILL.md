...
- **MCP tools** - All `mcp__chrome_devtools__*` tools for Chrome DevTools Protocol interaction
- **Bash** - For running Chrome if needed
- **Read, Write** - For saving artifacts and reports
