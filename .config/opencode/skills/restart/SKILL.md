...
metadata:
  source: /Users/james/.pi/agent/skills/pi-restart/SKILL.md
  original_name: pi-restart
---

# Restart Server

Converted from `/Users/james/.pi/agent/skills/pi-restart/SKILL.md`. Imported as `restart` for OpenCode.
...
If you cannot determine the server type, ask the user with `question`: "How do you start your server?" with options based on common patterns found in the project.
