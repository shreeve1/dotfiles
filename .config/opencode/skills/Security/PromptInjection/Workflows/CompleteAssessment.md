...
**Save to:**
```
~/.pai/History/research/YYYY-MM-DD_[client]-recon/
...
```
~/.pai/History/research/YYYY-MM-DD_[client]-direct-injection/
├── findings.md
...
**Document findings in:**
```
~/.pai/History/research/YYYY-MM-DD_[client]-indirect-injection/
├── findings.md
├── poisoned-documents/
├── test-web-pages/
...
```
~/.pai/History/research/YYYY-MM-DD_[client]-multistage/
...
**Document in:**
```
~/.pai/History/research/YYYY-MM-DD_[client]-defenses/
...
**Deliverables:**
```
~/.pai/History/research/YYYY-MM-DD_[client]-final-report/
