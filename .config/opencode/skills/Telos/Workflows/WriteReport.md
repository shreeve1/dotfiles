...
cp -r ${PAI_DIR:-$HOME/.pai}/skills/Telos/ReportTemplate/* {output_dir}/
...
```
${PAI_DIR:-$HOME/.pai}/skills/Telos/ReportTemplate/
```
...
Edit files in `${PAI_DIR:-$HOME/.pai}/skills/Telos/ReportTemplate/components/`

**To change color scheme:**
Edit CSS custom properties in `${PAI_DIR:-$HOME/.pai}/skills/Telos/ReportTemplate/app/globals.css`
