...
!`FILE="$1"; CONTENT="$2"; DESCRIPTION="$3"; bun ${PAI_DIR:-$HOME/.pai}/skills/Telos/Tools/UpdateTelos.ts "$FILE" "$CONTENT" "$DESCRIPTION"`
...
Example:
```bash
bun ${PAI_DIR:-$HOME/.pai}/skills/Telos/Tools/UpdateTelos.ts "BOOKS.md" "- *Project Hail Mary* by Andy Weir" "Added favorite book: Project Hail Mary"
```
...
The script is at: `${PAI_DIR:-$HOME/.pai}/skills/Telos/Tools/UpdateTelos.ts`
