...
```bash
cp -r ${PAI_DIR:-$HOME/.pai}/skills/telos/dashboard-template /path/to/your/project
...
- Searches `${PAI_DIR:-$HOME/.pai}/skills/Telos/` for `.md` files
- Searches `${PAI_DIR:-$HOME/.pai}/skills/Telos/data/` for `.csv` files
