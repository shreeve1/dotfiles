...
```bash
Read ${PAI_DIR:-$HOME/.pai}/skills/Media/Art/SKILL.md
```
...
bun run ${PAI_DIR:-$HOME/.pai}/skills/art/Tools/Generate.ts \
...
**See:** `${PAI_DIR:-$HOME/.pai}/skills/Images/Workflows/BackgroundRemoval.md` for full documentation.
