...
# Load: ${PAI_DIR:-$HOME/.pai}/skills/Parser/Workflows/ExtractYoutube.md
```
...
```typescript
import { PAI_THEME } from '${PAI_DIR:-$HOME/.pai}/skills/Remotion/theme'
...
- Reference: `${PAI_DIR:-$HOME/.pai}/skills/Remotion/theme.ts`
