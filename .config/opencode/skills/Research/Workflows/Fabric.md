...
**Primary Skill:** `${PAI_DIR:-$HOME/.pai}/skills/Fabric/SKILL.md`
**Patterns Location:** `${PAI_DIR:-$HOME/.pai}/skills/Fabric/Patterns/`
...
Patterns are managed by the Fabric skill at `${PAI_DIR:-$HOME/.pai}/skills/Fabric/`.
...
```bash
ls ${PAI_DIR:-$HOME/.pai}/skills/Fabric/Patterns/
```
...
**Full Pattern List:** `ls ${PAI_DIR:-$HOME/.pai}/skills/Fabric/Patterns/`
**Fabric Skill:** `${PAI_DIR:-$HOME/.pai}/skills/Fabric/SKILL.md`
**Fabric Documentation:** https://github.com/danielmiessler/fabric
**Pattern Templates:** See `${PAI_DIR:-$HOME/.pai}/skills/Fabric/Patterns/official_pattern_template/`
