...
- **Destination:** `${PAI_DIR:-$HOME/.pai}/skills/Research/Workflows/ClaudeResearch.md`
- **Size:** 3.6K
...
- **Destination:** `${PAI_DIR:-$HOME/.pai}/skills/Research/Workflows/PerplexityResearch.md`
- **Size:** 8.1K
...
- **Destination:** `${PAI_DIR:-$HOME/.pai}/skills/Research/Workflows/InterviewResearch.md`
- **Size:** 4.4K
...
- **Destination:** `${PAI_DIR:-$HOME/.pai}/skills/Research/Workflows/AnalyzeAiTrends.md`
- **Size:** 3.0K
...
**Location:** `${PAI_DIR:-$HOME/.pai}/skills/Research/Workflows/`
