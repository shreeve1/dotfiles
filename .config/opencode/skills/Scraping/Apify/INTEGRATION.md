...
**Location:** `${PAI_DIR:-$HOME/.pai}/skills/social/SKILL.md`
...
2. System runs: `bun ~/.pai/filesystem-mcps/apify/get-latest-tweet.ts`
...
bun ~/.pai/filesystem-mcps/apify/get-user-tweets.ts ThePrimeagen 10

# Analyze Paul Graham's recent thoughts
bun ~/.pai/filesystem-mcps/apify/get-user-tweets.ts paulg 20

# Track Simon Willison's posts
bun ~/.pai/filesystem-mcps/apify/get-user-tweets.ts simonw 15
```
...
bun ~/.pai/filesystem-mcps/apify/get-latest-thread.ts
...
bun ~/.pai/filesystem-mcps/apify/get-latest-tweet.ts
...
✅ Run from `~/.pai/filesystem-mcps/apify/` directory or use full path
...
**For Users:**
- Quick reference: `~/.pai/filesystem-mcps/SCRIPTS-REFERENCE.md`
- Social skill: `${PAI_DIR:-$HOME/.pai}/skills/social/SKILL.md`

**For Developers:**
- Implementation: `~/.pai/filesystem-mcps/apify/README.md`
- Standards: `~/.pai/filesystem-mcps/STANDARDS.md`
- Parent guide: `~/.pai/filesystem-mcps/README.md`
