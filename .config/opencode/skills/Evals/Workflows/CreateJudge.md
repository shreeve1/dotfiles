...
Create `${PAI_DIR:-$HOME/.pai}/skills/Evals/UseCases/<name>/judge-config.yaml`:
...
bun run ~/.pai/Templates/Tools/RenderTemplate.ts \
  -t Evals/Judge.hbs \
  -d ${PAI_DIR:-$HOME/.pai}/skills/Evals/UseCases/<name>/judge-config.yaml \
  -o ${PAI_DIR:-$HOME/.pai}/skills/Evals/UseCases/<name>/judge-prompt.md \
  --preview
```
