...
| `BrowserAgent` | Spawn `Task(subagent_type="browser-automation", prompt=resolved_template)` |
| `UIReviewer` | Spawn `Task(subagent_type="ui-reviewer", prompt=resolved_template)` |
