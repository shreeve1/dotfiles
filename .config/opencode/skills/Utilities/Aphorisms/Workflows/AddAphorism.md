...
**Prerequisites:**
- Aphorism database exists at `${PAI_DIR:-$HOME/.pai}/skills/aphorisms/Database/aphorisms.md`
...
**Read database:**
```bash
Read ${PAI_DIR:-$HOME/.pai}/skills/aphorisms/Database/aphorisms.md
```
...
Edit(
  file_path=${PAI_DIR:-$HOME/.pai}/skills/aphorisms/Database/aphorisms.md,
