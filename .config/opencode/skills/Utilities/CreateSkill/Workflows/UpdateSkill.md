...
```bash
${PAI_DIR:-$HOME/.pai}/skills/[SkillName]/SKILL.md
```
...
```bash
touch ${PAI_DIR:-$HOME/.pai}/skills/[SkillName]/Tools/ToolName.ts
touch ${PAI_DIR:-$HOME/.pai}/skills/[SkillName]/Tools/ToolName.help.md
```
