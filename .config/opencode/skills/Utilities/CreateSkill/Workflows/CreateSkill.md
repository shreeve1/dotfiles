...
2. Read the canonical example: `${PAI_DIR:-$HOME/.pai}/skills/Research/SKILL.md`
...
```bash
mkdir -p ${PAI_DIR:-$HOME/.pai}/skills/[SkillName]/Workflows
mkdir -p ${PAI_DIR:-$HOME/.pai}/skills/[SkillName]/Tools
```

**Example:**
```bash
mkdir -p ${PAI_DIR:-$HOME/.pai}/skills/YourSkill/Workflows
mkdir -p ${PAI_DIR:-$HOME/.pai}/skills/YourSkill/Tools
```
...
```bash
touch ${PAI_DIR:-$HOME/.pai}/skills/[SkillName]/Workflows/[WorkflowName].md
```
...
**Examples (TitleCase):**
```bash
touch ${PAI_DIR:-$HOME/.pai}/skills/YourSkill/Workflows/UpdateDaemonInfo.md
touch ${PAI_DIR:-$HOME/.pai}/skills/YourSkill/Workflows/UpdatePublicRepo.md
touch ${PAI_DIR:-$HOME/.pai}/skills/YourSkill/Workflows/Create.md
touch ${PAI_DIR:-$HOME/.pai}/skills/YourSkill/Workflows/Publish.md
```
...
Run this check:
```bash
ls ${PAI_DIR:-$HOME/.pai}/skills/[SkillName]/
ls ${PAI_DIR:-$HOME/.pai}/skills/[SkillName]/Workflows/
ls ${PAI_DIR:-$HOME/.pai}/skills/[SkillName]/Tools/
```
