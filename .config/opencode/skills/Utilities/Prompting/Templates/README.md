...
```bash
bun run ${PAI_DIR:-$HOME/.pai}/skills/Utilities/Prompting/Tools/RenderTemplate.ts \
...
```bash
bun run ${PAI_DIR:-$HOME/.pai}/skills/Utilities/Prompting/Tools/ValidateTemplate.ts \
...
- `${PAI_DIR:-$HOME/.pai}/skills/Utilities/Evals/SKILL.md`
