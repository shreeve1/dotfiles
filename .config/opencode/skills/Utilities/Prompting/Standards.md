...
**Location:** `${PAI_DIR:-$HOME/.pai}/skills/Utilities/Fabric/Patterns/`
...
```bash
${PAI_DIR:-$HOME/.pai}/skills/Utilities/Fabric/Tools/update-patterns.sh
```
...
All templates live in `${PAI_DIR:-$HOME/.pai}/skills/Utilities/Prompting/Templates/`:
...
**CLI Usage:**
```bash
bun ${PAI_DIR:-$HOME/.pai}/skills/Utilities/Prompting/Tools/RenderTemplate.ts \
...
**Programmatic Usage:**
```typescript
import { renderTemplate } from '${PAI_DIR:-$HOME/.pai}/skills/Utilities/Prompting/Tools/RenderTemplate.ts';
