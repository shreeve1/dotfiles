...
import { insertNewsletterContent } from '${PAI_DIR:-$HOME/.pai}/skills/parser/db';
...
- For traditional PDF extraction (text-only), see `${PAI_DIR:-$HOME/.pai}/skills/documents/pdf/SKILL.md`
- For PDF form filling, see `${PAI_DIR:-$HOME/.pai}/skills/documents/pdf/forms.md`
- For parser integration, see `${PAI_DIR:-$HOME/.pai}/skills/parser/SKILL.md`
