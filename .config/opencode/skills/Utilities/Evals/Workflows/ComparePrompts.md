...
```bash
# Check prompts exist
ls ${PAI_DIR:-$HOME/.pai}/skills/Utilities/Evals/UseCases/<name>/prompts/
...
Create `${PAI_DIR:-$HOME/.pai}/skills/Utilities/Evals/UseCases/<name>/comparisons/<comparison-name>.yaml`:
...
bun run ~/.pai/Templates/Tools/RenderTemplate.ts \
  ...
  -d ${PAI_DIR:-$HOME/.pai}/skills/Utilities/Evals/UseCases/<name>/comparisons/<name>.yaml \
  -o ${PAI_DIR:-$HOME/.pai}/skills/Utilities/Evals/UseCases/<name>/comparisons/<name>-setup.md \
  --preview
```
