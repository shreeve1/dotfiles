...
- Model template at `${PAI_DIR:-$HOME/.pai}/skills/WorldThreatModelHarness/ModelTemplate.md`
...
```
Read ~/.pai/memory/RESEARCH/WorldModels/INDEX.md (if exists)
...
Save to: `~/.pai/memory/RESEARCH/WorldModels/{horizon}.md`

### Step 5: Update INDEX

Write/update `~/.pai/memory/RESEARCH/WorldModels/INDEX.md`:
