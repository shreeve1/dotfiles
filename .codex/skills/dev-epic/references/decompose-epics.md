...
- [Variables](#variables)
- [Phase 1 — Load PRD](#phase-1-load-prd)
- [Phase 2 — Scope Gate](#phase-2-scope-gate)
- [Phase 3 — Propose Epic Groupings](#phase-3-propose-epic-groupings)
- [Phase 4 — Determine Sequencing](#phase-4-determine-sequencing)
- [Phase 5 — Generate Mini-PRDs](#phase-5-generate-mini-prds)
  - [Mini-PRD Format](#mini-prd-format)
- [Phase 6 — Write Output Files](#phase-6-write-output-files)
  - [README.md Format](#readmemd-format)
- [Phase 7 — Report](#phase-7-report)
  - [Report Format A: No-op](#report-format-a-no-op)
  - [Report Format B: Decomposed](#report-format-b-decomposed)
...
1. **Locate PRD**
   ...
   - If not provided: list `.md` files in `PRD_DIRECTORY` sorted by modification time (newest first), present via `ask the user`
...
2. **Propose groupings via ask the user**
   ```
...
2. **Propose sequencing via ask the user**
   ```
