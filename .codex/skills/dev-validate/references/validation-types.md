...
- [Validation Type 1: Breaking Changes Analysis](#validation-type-1-breaking-changes-analysis)
- [Validation Type 2: Database Safety Validation](#validation-type-2-database-safety-validation)
- [Validation Type 3: Component Impact Analysis](#validation-type-3-component-impact-analysis)
- [Validation Type 4: Dependency Graph Validation](#validation-type-4-dependency-graph-validation)
- [Validation Type 5: Test Coverage Validation](#validation-type-5-test-coverage-validation)
- [Validation Type 6: Infrastructure Safety](#validation-type-6-infrastructure-safety)
- [Validation Type 7: Traceability Validation](#validation-type-7-traceability-validation)
- [Analysis Output Format](#analysis-output-format)
- [Reporting to User](#reporting-to-user)
...
When the validation analysis determines required validations, it returns:
