...
PRD exists. It can block finalization of active substantive work when the final
response has not reviewed the work, reported verification, or considered
learning. This keeps Codex usable for small fixes while making non-trivial work
visibly accountable to the PAI loop.
