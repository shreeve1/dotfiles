...
Local pipeline definitions live in `.codex/pai/PAI/PIPELINES/[Domain]_[Pipeline-Name]/PIPELINE.md`
...
```bash
mkdir -p .codex/pai/PAI/PIPELINES/[Domain]_[Pipeline-Name]
# PIPELINE-TEMPLATE.md is planned but not yet created
# For now, copy an existing pipeline and modify it
cp .codex/pai/PAI/PIPELINES/Blog_Publish-Post/PIPELINE.md .codex/pai/PAI/PIPELINES/[Domain]_[Pipeline-Name]/PIPELINE.md
```
...
- **Actions:** `.codex/pai/PAI/ACTIONS.md`
- **Flows:** `.codex/pai/PAI/FLOWS.md`
- **Architecture:** `.codex/pai/PAI/PAISYSTEMARCHITECTURE.md`
- **Detailed README:** `.codex/pai/PAI/PIPELINES/README.md`
