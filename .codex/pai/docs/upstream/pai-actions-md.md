...
Each action is a flat directory under `.codex/pai/PAI/ACTIONS/`:
...
mkdir .codex/pai/PAI/USER/ACTIONS/A_YOUR_ACTION
```
...
- **Pipelines:** `.codex/pai/PAI/PIPELINES.md`
- **Flows:** `.codex/pai/PAI/FLOWS.md`
- **Architecture:** `.codex/pai/PAI/PAISYSTEMARCHITECTURE.md`
- **Personal Actions:** `.codex/pai/PAI/USER/ACTIONS/`
