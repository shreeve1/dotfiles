...
**Primary Skill:** `.codex/pai/skills/Fabric/SKILL.md`
...
**Patterns Location:** `.codex/pai/skills/Fabric/Patterns/` (237 patterns)
...
-> Runs fabric -U
-> Syncs to .codex/pai/skills/Fabric/Patterns/
```

**Manual:**
```bash
fabric -U && rsync -av ~/.config/fabric/patterns/ .codex/pai/skills/Fabric/Patterns/
```
...
- **Full Skill:** `.codex/pai/skills/Fabric/SKILL.md`
- **Pattern Execution:** `.codex/pai/skills/Fabric/Workflows/ExecutePattern.md`
- **Pattern Updates:** `.codex/pai/skills/Fabric/Workflows/UpdatePatterns.md`
- **All Patterns:** `.codex/pai/skills/Fabric/Patterns/`
