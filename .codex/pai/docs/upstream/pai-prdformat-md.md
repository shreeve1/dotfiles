...
```
.codex/pai/MEMORY/WORK/{slug}/PRD.md
```
...
- **Reference file pattern**: This spec lives at `.codex/pai/PAI/PRDFORMAT.md`, not inline in AGENTS.md. Saves ~2,500 tokens/response.
