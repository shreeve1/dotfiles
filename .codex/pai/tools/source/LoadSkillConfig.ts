 ...
 *
 * Usage:
 *   import { loadSkillConfig } from '.codex/pai/PAI/Tools/LoadSkillConfig';
 *   const config = loadSkillConfig<MyConfigType>(__dirname, 'config.json');
 *
 * Or CLI:
 *   bun .codex/pai/PAI/Tools/LoadSkillConfig.ts <skill-dir> <filename>
 */
...
Examples:
  bun LoadSkillConfig.ts .codex/pai/skills/PAIUpgrade sources.json
