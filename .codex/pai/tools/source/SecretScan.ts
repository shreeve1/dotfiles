 ...
 *
 * Usage:
 *   bun .codex/pai/PAI/Tools/SecretScan.ts <directory>
 *   bun .codex/pai/PAI/Tools/SecretScan.ts . --verbose
 *   bun .codex/pai/PAI/Tools/SecretScan.ts . --verify
 *
 * @see .codex/pai/skills/_SYSTEM/Workflows/SecretScanning.md
 */
