...
```
spawn_agent(subagent_type="BrowserAgent", prompt="Navigate to https://example.com. Take a snapshot. Report page title.")
```
...
# Headed mode: claude --chrome (Codex Chrome integration)
