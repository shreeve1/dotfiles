...
| `BrowserAgent` | Spawn `spawn_agent(subagent_type="BrowserAgent", prompt=resolved_template)` |
| `UIReviewer` | Spawn `spawn_agent(subagent_type="UIReviewer", prompt=resolved_template)` |
