...
Rating 10: RGB(85, 220, 125)  -> \u001b[38;2;85;220;125m  # Bright cyan-green (L80)
Rating  9: RGB(65, 195, 105)  -> \u001b[38;2;65;195;105m  # Vibrant cyan-green (L70)
Rating  8: RGB(50, 170, 90)   -> \u001b[38;2;50;170;90m   # Medium green-cyan (L60)
Rating  7: RGB(40, 145, 75)   -> \u001b[38;2;40;145;75m   # Moderate green (L50)
Rating  6: RGB(35, 120, 65)   -> \u001b[38;2;35;120;65m   # Subtle green (L42)

# Neutral center
Rating  5: RGB(130, 130, 110) -> \u001b[38;2;130;130;110m  # Warm gray (L52)

# Negative gradient (downward blocks, decreasing luminance)
Rating  4: RGB(190, 145, 60)  -> \u001b[38;2;190;145;60m  # Amber/orange (L60)
Rating  3: RGB(200, 110, 45)  -> \u001b[38;2;200;110;45m  # Orange-red (L50)
Rating  2: RGB(185, 70, 35)   -> \u001b[38;2;185;70;35m   # Strong red (L38)
Rating  1: RGB(150, 45, 30)   -> \u001b[38;2;150;45;30m   # Deep dark red (L28)
```

**Luminance Calculation (Approximate):**
Using simplified L* = (0.299R + 0.587G + 0.114B) / 2.55
