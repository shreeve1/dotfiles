...
- World models must exist at `.codex/pai/MEMORY/RESEARCH/WorldModels/`
...
```
Check .codex/pai/MEMORY/RESEARCH/WorldModels/ for all 11 model files.
...
Read all 11 model files from `.codex/pai/MEMORY/RESEARCH/WorldModels/`.
...
1. Spawn up to 11 parallel agents (Codex subagent tools, `run_in_background: true`)
2. Each agent:
