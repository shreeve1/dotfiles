---
name: "pai-thinking-worldthreatmodelharness"
description: "PAI Codex port: Stress-test ideas, strategies, and investments across 11 time horizons (6mo-50yr). Update and view world models. USE WHEN threat model, world model, test idea, test strategy, future analysis, test investment, test again..."
---
...
Models are stored at: `CODEX_PAI_ROOT/MEMORY/RESEARCH/WorldModels/`
...
`.codex/pai/PAI/USER/SKILLCUSTOMIZATIONS/WorldThreatModelHarness/`
