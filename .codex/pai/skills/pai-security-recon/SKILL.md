---
name: "pai-security-recon"
description: "PAI Codex port: Network reconnaissance - subdomain enumeration, port scanning, DNS/WHOIS/ASN lookups, endpoint discovery from JS, mass scanning, path discovery, CIDR/netblock analysis. Passive and active modes with corporate structure..."
---
...
`.codex/pai/PAI/USER/SKILLCUSTOMIZATIONS/Recon/`
...
Active reconnaissance should have:
...
- `naabu` - Port scanning
- Note: Requires security MCP profile (`.codex/pai/MCPs/swap-mcp security`)
...
Reports saved to:
- **Work directory** (`.codex/pai/MEMORY/WORK/{current_work}/`) - For iterative artifacts during investigation
- **MEMORY/RESEARCH/** (`.codex/pai/MEMORY/RESEARCH/YYYY-MM/`) - For pentest engagements and formal assessments
...
.codex/pai/MCPs/swap-mcp security
...
Assistant: Activating recon skill with passive-recon workflow.
     ...
     Report: .codex/pai/MEMORY/WORK/{current_work}/recon-example-com/
```
...
**Security Skills:**
- `.codex/pai/skills/Investigation/` - Entity and people reconnaissance (OSINT)
- `.codex/pai/skills/Security/WebAssessment/` - Web application testing
