...
- "Read this page" -> Use web access directly
- "Get content from [URL]" -> Use web access directly
- "What does this site say" -> Use web access directly
- "Fetch this article" -> Use web access directly
- "Check this URL" -> Use web access directly
...
**When to use:**
- Layer 1 web access failed with blocking/CAPTCHA
...
- Layer 1 web search insufficient
...
web access({ url: url1, prompt: "Extract main content" })
web access({ url: url2, prompt: "Extract main content" })
// ... (can run in parallel)
...
**Working Directory:** `.codex/pai/MEMORY/WORK/{current_work}/`
...
2. **History (Permanent Archive):**
   ...
   - Move to `.codex/pai/History/research/YYYY-MM-DD_[description]/` when complete
...
```
.codex/pai/MEMORY/WORK/20260111-172408_retrieve-react19-docs/
 raw-content/
...
```
.codex/pai/History/research/2025-10-26_react19-documentation/
...
## Layers & Tools Used
- Layer 1: web access (success/failed)
