...
- **avoid** use yt-dlp or youtube-dl
- **avoid** use web scraping for YouTube
- **avoid** use transcription APIs directly
...
For Fabric patterns: `read .codex/pai/docs/fabric-patterns.md`
