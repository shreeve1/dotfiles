...
**Patterns Location:** `.codex/pai/skills/Fabric/Patterns/`
...
Patterns are managed by the Fabric skill at `.codex/pai/skills/Fabric/`.
...
```bash
ls .codex/pai/skills/Fabric/Patterns/
```
...
**Full Pattern List:** `ls .codex/pai/skills/Fabric/Patterns/`
**Fabric Skill:** `.codex/pai/skills/Fabric/SKILL.md`
**Fabric Documentation:** https://github.com/danielmiessler/fabric
**Pattern Templates:** See `.codex/pai/skills/Fabric/Patterns/official_pattern_template/`
