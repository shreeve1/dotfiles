...
```
.codex/pai/MEMORY/RESEARCH/{YYYY-MM}/{YYYY-MM-DD}_{topic-slug}/
```

Read `.codex/pai/MEMORY/STATE/current-work.json` for the active work directory.
...
Templates live at `.codex/pai/skills/Research/Templates/{DomainName}.md`
