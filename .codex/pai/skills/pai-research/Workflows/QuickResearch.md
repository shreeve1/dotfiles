...
**Mode:** Single Codex researcher, 1 query | **Timeout:** 30 seconds
...
### Step 1: Launch Single Codex Agent

**ONE spawn_agent call - Codex researcher with a single focused query:**
...
```markdown
 ...
 ANALYSIS: [Key findings from Codex]
 ACTIONS: 1 Codex query
 RESULTS: [Answer]
