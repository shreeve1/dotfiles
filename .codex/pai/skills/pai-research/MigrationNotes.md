...
### 1. Codex web search Research
- **Source:** `.codex/pai/commands/perform-claude-research.md`
- **Destination:** `.codex/pai/skills/Research/Workflows/ClaudeResearch.md`
- **Size:** 3.6K
- **Description:** Intelligent query decomposition with Codex's web search tool (free, no API keys)
- **Triggers:** "claude research", "use websearch", "claude only"

### 2. Perplexity API Research
- **Source:** `.codex/pai/commands/perform-perplexity-research.md`
- **Destination:** `.codex/pai/skills/Research/Workflows/PerplexityResearch.md`
- **Size:** 8.1K
...
- **Source:** `.codex/pai/commands/perform-interview-research.md`
- **Destination:** `.codex/pai/skills/Research/Workflows/InterviewResearch.md`
- **Size:** 4.4K
...
- **Source:** `.codex/pai/commands/analyze-ai-trends.md`
- **Destination:** `.codex/pai/skills/Research/Workflows/AnalyzeAiTrends.md`
- **Size:** 3.0K
...
**Location:** `.codex/pai/skills/Research/Workflows/`
...
- `ClaudeResearch.md` - Codex web search only
...
4. **Codex web search Research** - `Workflows/ClaudeResearch.md`
...
The original command files remain in `.codex/pai/commands/`:
