...
| "do research", "research this" | Standard | 3 agents (Perplexity + Codex + Gemini) | ~15-30s |
...
1. **Layer 1:** web access/web search (try first)
...
-> Spawns 3 agents in parallel (Perplexity + Codex + Gemini)
