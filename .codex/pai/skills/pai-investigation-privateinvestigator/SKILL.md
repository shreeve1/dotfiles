---
name: "pai-investigation-privateinvestigator"
description: "PAI Codex port: Ethical people-finding using 15 parallel research agents (45 search threads) across public records, social media, reverse lookups. Public data only, no pretexting. USE WHEN find person, locate, reconnect, people search,..."
---
...
`.codex/pai/PAI/USER/SKILLCUSTOMIZATIONS/PrivateInvestigator/`
...
**important: Extensive Parallel Research**
...
**Launch Pattern:** All 15 agents launch in a SINGLE message with multiple Codex subagent tools calls.
