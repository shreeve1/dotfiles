---
name: "pai-thinking-science"
description: "PAI Codex port: Hypothesis-test-analyze cycles for systematic problem-solving - the meta-skill governing all others. Includes define goal, generate hypotheses, design experiment, measure results, analyze results, iterate, full cycle, q..."
---
...
`.codex/pai/PAI/USER/SKILLCUSTOMIZATIONS/Science/`
...
2. **Hypothesis Plurality** - avoid just one idea (minimum 3)
