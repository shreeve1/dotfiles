...
### Step 1: Tier 1 - web access (Fast & Simple)

**Description:** Attempt to fetch URL using Codex's built-in web access tool

**Actions:**
```
Use web access tool with:
...
- **Failure:** web access blocked, timeout, or error -> Proceed to Step 2 (Tier 2)
...
Process:
1. Attempt Tier 1 (web access)
2. Success in 3 seconds
3. Return content

Output:
```markdown
Successfully retrieved content from https://example.com using Tier 1 (web access)
...
Process:
1. Attempt Tier 1 (web access) -> Blocked (403)
