---
name: "pai-utilities-documents-pdf"
description: "PAI Codex port: Create, merge, split, extract text/tables from PDFs, fill forms, add watermarks, and convert to/from other formats. USE WHEN pdf, PDF file, merge PDF, extract tables, fill form, split PDF."
---
...
### Direct PDF spawn_agent Triggers
...
| spawn_agent | Best Tool | Command/Code |
|------|-----------|--------------|
