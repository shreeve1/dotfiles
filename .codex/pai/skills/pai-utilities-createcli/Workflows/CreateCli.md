...
**Reference:** `.codex/pai/PAI/CliFirstArchitecture.md` (Configuration Flags section)
...
For more information, see .codex/pai/Bin/{{CLI_NAME}}/README.md
...
See: .codex/pai/Bin/{{CLI_NAME}}/README.md
```
...
**Report to user:**
```
 CLI Created: .codex/pai/Bin/{{CLI_NAME}}/
...
Documentation: .codex/pai/Bin/{{CLI_NAME}}/README.md
```
...
**Generated Output:**
```
 CLI Created: .codex/pai/Bin/notioncli/
...
3. Read: .codex/pai/Bin/notioncli/README.md
...
Use proven structure from .codex/pai/Bin/llcli/ as reference.
