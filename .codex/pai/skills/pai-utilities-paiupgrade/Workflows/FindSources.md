...
| Category | Examples |
|----------|----------|
| **AI Development** | Codex tutorials, AI coding workflows |
...
```
Search: "Codex tutorial YouTube channel"
...
```
Search: site:github.com "Codex" examples
...
Edit `.codex/pai/PAI/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/youtube-channels.json`
...
cat .codex/pai/PAI/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/youtube-channels.json
