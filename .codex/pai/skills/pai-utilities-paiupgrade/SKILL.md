---
name: "pai-utilities-paiupgrade"
description: "PAI Codex port: Extract system improvements from content AND monitor external sources (Anthropic ecosystem, YouTube). USE WHEN upgrade, improve system, system upgrade, analyze for improvements, check Anthropic, Anthropic changes, new C..."
---
...
`.codex/pai/PAI/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/`
...
**Source:** Codex Docs - Tool Use section, updated 2026-01-20
**Priority:**  CRITICAL |  HIGH |  MEDIUM |  LOW
...
**Docs Analyzed:**
- Codex Tool Use docs -> [N] techniques extracted
```
...
Read and analyze:
- .codex/pai/MEMORY/STATE/current-work.json
...
Analyze:
- .codex/pai/skills/ (installed skills)
- .codex/pai/hooks/ (active hooks)
- .codex/pai/settings.json (configuration)
...
Run: bun .codex/pai/skills/Utilities/PAIUpgrade/Tools/Anthropic.ts
...
**User Customizations** (`.codex/pai/PAI/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/`):
...
|---------------|----------------|-------------------|
| "Check out R Amjad's video on Codex" | Points to content instead of extracting it | "@ 5:42, R Amjad shows this technique: [quote]" |
...
**Word count test:** Each "What It Is" and "How It Helps PAI" field should be 16-32 words. Count them. If under 16, add specificity. If over 32, condense.
