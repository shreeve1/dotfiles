---
name: "pai-utilities-documents-xlsx"
description: "PAI Codex port: Create, read, analyze Excel workbooks - formulas, financial models, data analysis, recalculation, and CSV/TSV conversion. USE WHEN xlsx, Excel, spreadsheet, formulas, financial model, data analysis."
---
...
- important step after using formulas - run `recalc.py` script

## All Excel files

### Zero Formula Errors
- Every Excel model should be delivered with ZERO formula errors (#REF!, #DIV/0!, #VALUE!, #N/A, #NAME?)

### Preserve Existing Templates (when updating templates)
- Study and EXACTLY match existing format, style, and conventions when modifying files
- Never impose standardized formatting on files with established patterns
- Existing template conventions usually override these guidelines
...
- **Currency**: Use $#,##0 format; usually specify units in headers ("Revenue ($mm)")
...
5. **Recalculate formulas (important IF USING FORMULAS)**: Use the recalc.py script
   ```bash
