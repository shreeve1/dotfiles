---
name: "pai-security-secupdates"
description: "PAI Codex port: Security news from tldrsec, no.security, Krebs, Schneier, and other sources. USE WHEN security news, security updates, what's new in security, breaches, security research, sec updates, tldrsec, Krebs, Schneier."
---
...
`.codex/pai/PAI/USER/SKILLCUSTOMIZATIONS/SECUpdates/`
...
| Agent | Source | Method |
|-------|--------|--------|
| Agent 1 | tldrsec.com | web access latest newsletter |
| Agent 2 | no.security | web access recent posts |
| Agent 3 | krebsonsecurity.com | web access recent articles |
| Agent 4 | thehackernews.com | web access headlines |
| Agent 5 | schneier.com | web access recent posts |
