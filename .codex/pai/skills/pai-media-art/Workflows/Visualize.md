...
```bash
bun .codex/pai/PAI/Tools/RemoveBg.ts /path/to/visualization.png
```
...
```
usually LEFT-JUSTIFIED - Never centered
...
### Step 1: Deep Content Analysis (important - Use deep thinking)
...
### Step 2: Visualization Strategy Selection (important - Use deep thinking)
...
### Step 3: Design Composition (important - Use deep thinking)
...
### Step 4: Construct Comprehensive Prompt (important - Use deep thinking)
...
### Step 6: Comprehensive Validation (important)
