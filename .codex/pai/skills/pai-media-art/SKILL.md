---
name: "pai-media-art"
description: "PAI Codex port: Generate illustrations, technical diagrams, mermaid flowcharts, infographics, header images, thumbnails, comics, and PAI pack icons using multiple rendering backends. USE WHEN art, header images, visualizations, mermaid..."
---
...
`.codex/pai/PAI/USER/SKILLCUSTOMIZATIONS/Art/`
...
##  important: Output to Downloads First

```

  ALL GENERATED IMAGES GO TO ~/Downloads/ FIRST
  avoid output directly to project directories
  User should preview in Finder/Preview before use
...
**Load from:** `.codex/pai/PAI/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md`
...
Check `.codex/pai/PAI/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md` for:
...
**ALL generated images should go to `~/Downloads/` first for preview and selection.**
...
bun run .codex/pai/skills/Media/Art/Tools/Generate.ts \
...
**API keys in:** `CODEX_PAI_ROOT/.env`
