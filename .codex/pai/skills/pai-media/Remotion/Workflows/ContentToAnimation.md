...
# Load: .codex/pai/skills/Parser/Workflows/ExtractYoutube.md
```
...
**important: Apply PAI Theme**
```typescript
import { PAI_THEME } from '.codex/pai/skills/Remotion/theme'
...
- Load: `.codex/pai/PAI/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md`
- Apply: Charcoal aesthetic, purple accents, organic animations
- Reference: `.codex/pai/skills/Remotion/theme.ts`
