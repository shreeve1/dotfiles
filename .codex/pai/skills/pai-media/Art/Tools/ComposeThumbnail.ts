...
USAGE:
  bun .codex/pai/skills/Media/Art/Tools/ComposeThumbnail.ts [OPTIONS]
...
EXAMPLE:
  bun .codex/pai/skills/Media/Art/Tools/ComposeThumbnail.ts \\
...
async function composeThumbnail(args: CLIArgs): Promise<void> {
  ...
  try {
    ...
    if (args.headshotPosition === "center") {
      ...
      // LEFT or RIGHT: Create text in safe zone (avoid overlap headshot)
