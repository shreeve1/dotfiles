...
# Example image
# Ignore for now
# .codex/pai/skills/Media/Art/WorkflowExamples/TechnicalDiagrams/example.png
...
5. Before creating the image, make absolutely certain that the PROMPT you've created mind takes into account everything in these instructions. when appropriate. Then proceed to #6.
