...
##  ALL STEPS ARE important - when appropriate

```

  EVERY SINGLE STEP BELOW IS important. EXECUTE ALL OF THEM.
  DO NOT SKIP ANY STEP. DO NOT ABBREVIATE. DO NOT SHORTCUT.
  IF YOU SKIP A STEP, YOU HAVE FAILED THE WORKFLOW.

```

**ALL 8 STEPS ARE important. Execute them IN ORDER. Do NOT skip steps.**

```
INPUT CONTENT

[1] UNDERSTAND: Deeply read and comprehend the request  important

[2] CSE-24: Run Create Story Explanation Level 24 on content  important

[3] EMOTION: Identify emotional register  important

[4] COMPOSITION: Design what to ACTUALLY DRAW  important

[5] PROMPT: Construct using charcoal sketch TECHNIQUE template  important

[6] GENERATE: Execute CLI tool with --thumbnail flag  important

[7] OPTIMIZE: Resize, convert to WebP, create optimized thumbnails  important

[8] VALIDATE: Subject matches content? Signature? Gallery-worthy?  important
```

**important ELEMENTS IN EVERY IMAGE:**
- Signature (small, charcoal, bottom right corner)
- Charcoal sketch technique
- Content-relevant subject matter
- **BURNT SIENNA (#8B4513)** - human warmth, humanity (important)
- **DEEP PURPLE (#4A148C)** - technology, AI, capital, cold power (important)
- --thumbnail flag for blog headers

** BOTH SIENNA AND PURPLE should BE PRESENT IN EVERY IMAGE.**
...
- The visual should make logical sense with the concept
...
## Step 1: Deeply Understand the Request - important
...
## Step 2: Run Create Story Explanation Level 24 - important
...
## Step 3: Identify Emotional Register - important

**Read the aesthetic file and select the appropriate emotional vocabulary.**

```bash
Read .codex/pai/skills/Media/Art/SKILL.md
```
...
## Step 4: Design Composition - important
...
## Step 5: Construct the Prompt - important
...
COMPOSITION - FULL FRAME IS important:
-  SUBJECTS should FILL THE ENTIRE FRAME - edge to edge horizontally and vertically
...
## Step 6: Execute the Generation - important
...
```bash
# usually output to Downloads first for user to review in Preview
bun run .codex/pai/skills/art/Tools/Generate.ts \
...
###  important: Blog Header Images -> Use `--thumbnail`

**ALL blog header images should use the `--thumbnail` flag.**
...
**usually reference the `-thumb` file in the blog post's `thumbnail:` frontmatter field:**
...
bun .codex/pai/PAI/Tools/RemoveBg.ts /path/to/output.png

# Or batch process multiple images
bun .codex/pai/PAI/Tools/RemoveBg.ts image1.png image2.png image3.png
```

**See:** `.codex/pai/skills/Images/Workflows/BackgroundRemoval.md` for full documentation.

###  COMPOSITION: USE FULL FRAME, MINIMALIST, NO BACKGROUNDS

**SUBJECTS FILL THE FRAME. FEW ELEMENTS. NO FILLED BACKGROUNDS.**

**usually include in prompt:**
...
## Step 7: Optimize Images (important)
...
## Step 8: Validation (important)

** CRITICAL: This step is important. Regenerate if validation fails.**
...
** important ELEMENTS (if ANY are missing, REGENERATE):**
...
**COLOR (all required - BOTH SIENNA AND PURPLE important):**
- [ ] **CHARCOAL/GRAY DOMINANT** - 70-85% of image
- [ ] **BURNT SIENNA (#8B4513) PRESENT** - on human/warm elements (important)
- [ ] **DEEP PURPLE (#4A148C) PRESENT** - on tech/capital/cold elements (important)
...
3. EMOTION -> Match to register in .codex/pai/PAI/aesthetic.md
