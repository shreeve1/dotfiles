...
```
spawn_agent 1: Jan 1 - Jan 15
spawn_agent 2: Jan 10 - Jan 30 (depends on spawn_agent 1)
spawn_agent 3: Jan 20 - Feb 10
```
...
### Step 1: Run Story Explanation on Content (important)

** CRITICAL: You should use /cse (Create Story Explanation) with 24-item length.**
...
- spawn_agent dependencies and schedules
...
```bash
bun .codex/pai/PAI/Tools/RemoveBg.ts /path/to/mermaid-diagram.png
```
...
### Step 8: Comprehensive Validation (important)
...
### Process Summary
```
1. Run /cse (24-item story explanation)  important
