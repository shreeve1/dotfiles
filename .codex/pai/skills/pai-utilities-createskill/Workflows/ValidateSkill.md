...
```bash
.codex/pai/skills/[SkillName]/SKILL.md
```
...
### Skill Directory
```bash
ls .codex/pai/skills/ | grep -i [skillname]
```
...
```bash
ls -la .codex/pai/skills/[SkillName]/
```
...
```bash
bun .codex/pai/skills/[SkillName]/Tools/[ToolName].ts --help
```
...
```bash
grep -l "Intent-to-Flag" .codex/pai/skills/[SkillName]/Workflows/*.md
```
...
**Reference:** `.codex/pai/PAI/CliFirstArchitecture.md`
