...
spawn_agent({ subagent_type: "PerplexityResearcher", prompt: "Entity verification" })
spawn_agent({ subagent_type: "ClaudeResearcher", prompt: "Leadership backgrounds" })
spawn_agent({ subagent_type: "GeminiResearcher", prompt: "Competitive analysis" })
spawn_agent({ subagent_type: "GrokResearcher", prompt: "Risk assessment" })
```
