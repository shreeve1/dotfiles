...
```bash
bun run .codex/pai/skills/Utilities/Prompting/Tools/RenderTemplate.ts \
...
```bash
bun run .codex/pai/skills/Utilities/Prompting/Tools/ValidateTemplate.ts \
...
| Brief an agent | `Briefing.hbs` | spawn_agent context |
...
- `.codex/pai/PAI/Prompting.md` (Templating section)
- `.codex/pai/History/research/2025-12/2025-12-09-templating-system-research.md`
- `.codex/pai/History/learnings/2025-12/2025-12-09-021700_LEARNING_complete-templating-system-and-evals-integration.md`
- `.codex/pai/skills/Utilities/Evals/SKILL.md`
