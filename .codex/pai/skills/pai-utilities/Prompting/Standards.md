...
description: Prompt engineering standards based on Anthropic's Codex 4.x best practices (November 2025), context engineering principles, and the Fabric system. Universal principles for semantic clarity, multi-context workflows, and agentic coding patterns. Validated by empirical research showing 10-90% performance impact from structure choices.
---

# Prompt Engineering Standards

**Foundation:** Based on Anthropic's Codex 4.x Best Practices (November 2025), context engineering principles, and the Fabric system. Validated by empirical research across 1,500+ academic papers and production systems.

**Philosophy:** Universal principles of semantic clarity and structure that work regardless of model implementation, with specific optimizations for Codex 4.x behavioral patterns.
...
Codex 4.x requires clear, specific direction rather than vague requests.
...
Explain *why* certain behavior matters to help Codex understand goals.
...
Codex generalizes well from reasoning provided in context.
...
**Why it works:** Positive framing gives Codex a clear target rather than a void to avoid.
...
**New in Codex 4.x:** Optimized patterns for long-horizon tasks spanning multiple context windows.
...
- **Codex 4.5 excels at discovering state from filesystem**
...
Codex 4.5 tracks remaining context throughout conversations:
```
...
**Codex 4.5 naturally recognizes when tasks benefit from specialized subagent delegation.**
...
**Codex 4.5 excels at synthesizing information from large corpora.**
...
- **Codex 4.x pays close attention-ensure examples match desired outcomes exactly**
...
- **Consider full context reset-Codex 4.5 excels at discovering state from filesystem**
...
- **Codex 4.5 naturally recognizes delegation opportunities**
...
## Tool Description Language (Codex 4.5 Specific)

- **Avoid:** "CRITICAL: You should use this tool"
...
## Available Tools
- `tool_name(params)` - [Brief description - avoid "should use" language]
...
- [ ] Tool descriptions use soft language (avoid "should")
...
"CRITICAL: You should use this tool" causes overtriggering in Codex 4.5.
...
**Location:** `.codex/pai/skills/Utilities/Fabric/Patterns/`
...
```bash
.codex/pai/skills/Utilities/Fabric/Tools/update-patterns.sh
```
...
# Migration to Codex 4.x

When updating prompts for Codex 4.x:
...
4. **Soften tool language:** Change "should" to "when..."
...
**Philosophy:** These standards focus on universal principles of semantic clarity and structure while incorporating Codex 4.x-specific optimizations for behavioral patterns, tool usage, and multi-context workflows.

---

# The Ultimate Prompt Template

**Synthesized from:** Anthropic's Codex 4.x Best Practices, context engineering principles, 1,500+ academic papers, and production-validated patterns.

**Design Philosophy:** Modular sections-include only what your task requires. Every section is optimized for Codex 4.x behavioral patterns.
...
## Context & Motivation
[WHY this matters - Codex generalizes from reasoning provided]
...
## Examples
[1-3 examples optimal. Codex 4.x is HIGHLY sensitive to details.]
[Examples should exactly match desired outcomes - misalignment causes unintended behavior]

**Example 1: [Scenario]**
- Input: [Representative input]
- Output: [Exact desired output - Codex will match this closely]
...
## Tools
[SOFT LANGUAGE - avoid "should use" which causes overtriggering]
...
| spawn_agent Type | Required Sections | Recommended | Optional |
|-----------|------------------|-------------|----------|
...
## Quick Reference: Codex 4.x Transformations

|  Avoid |  Use Instead |
|----------|---------------|
| "CRITICAL: You should use this tool" | "Use this tool when..." |
| "Don't use markdown" | "Write in flowing prose paragraphs" |
| "avoid do X" | "Do Y instead" (positive framing) |
...
**Why Handlebars:**
- Anthropic's official Codex Console syntax
...
{{#if gate.mandatory}}
** important (if ANY missing, {{gate.action_on_fail}}):**
{{/if}}
...
All templates live in `.codex/pai/skills/Utilities/Prompting/Templates/`:
...
**CLI Usage:**
```bash
bun .codex/pai/skills/Utilities/Prompting/Tools/RenderTemplate.ts \
...
**Programmatic Usage:**
```typescript
import { renderTemplate } from '.codex/pai/skills/Utilities/Prompting/Tools/RenderTemplate.ts';
