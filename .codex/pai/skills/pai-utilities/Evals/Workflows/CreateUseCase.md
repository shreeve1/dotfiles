...
```bash
mkdir -p .codex/pai/skills/Utilities/Evals/UseCases/<name>/{test-cases,golden-outputs,prompts}
```

### Step 3: Create Config File

Create `.codex/pai/skills/Utilities/Evals/UseCases/<name>/config.yaml`:
...
Create `.codex/pai/skills/Utilities/Evals/UseCases/<name>/prompts/v1.0.0.md`:

```markdown
# <spawn_agent Name> Prompt v1.0.0
...
Create test cases in `.codex/pai/skills/Utilities/Evals/UseCases/<name>/test-cases/`:
...
Create `.codex/pai/skills/Utilities/Evals/UseCases/<name>/README.md`:
...
\`\`\`bash
bun run .codex/pai/skills/Utilities/Evals/EvalServer/cli-run.ts --use-case <name>
\`\`\`
...
```bash
# Check structure
ls -la .codex/pai/skills/Utilities/Evals/UseCases/<name>/

# Validate config
bun run .codex/pai/skills/Utilities/Evals/EvalServer/cli.ts use-case show <name>
```
