...
```bash
# Check prompts exist
ls .codex/pai/skills/Utilities/Evals/UseCases/<name>/prompts/
...
Create `.codex/pai/skills/Utilities/Evals/UseCases/<name>/comparisons/<comparison-name>.yaml`:
...
- If testing Codex prompts -> Use GPT-4o as judge
- If testing GPT prompts -> Use Codex as judge
...
bun run .codex/pai/Templates/Tools/RenderTemplate.ts \
  ...
  -d .codex/pai/skills/Utilities/Evals/UseCases/<name>/comparisons/<name>.yaml \
  -o .codex/pai/skills/Utilities/Evals/UseCases/<name>/comparisons/<name>-setup.md \
  --preview
```
