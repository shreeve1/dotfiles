...
#   001-tech-article:    Run A: 0.92   Run B: 0.88   ( +0.04)
#   002-long-form:       Run A: 0.85   Run B: 0.79   ( +0.06)
#   003-edge-case:       Run A: 0.65   Run B: 0.72   ( -0.07)
#   004-technical:       Run A: 0.88   Run B: 0.85   ( +0.03)
#   005-casual:          Run A: 0.91   Run B: 0.86   ( +0.05)
#
# Summary:
...
#
# Winner: claude-3-5-sonnet ( +0.03 vs 2nd place)
```
...
#
# Best: v2.0.0 ( +0.09 vs baseline v1.0.0)
