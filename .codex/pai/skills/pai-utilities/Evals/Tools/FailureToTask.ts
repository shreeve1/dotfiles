#!/usr/bin/env bun
/**
 * Failure to spawn_agent Converter
...
import type { FailureLog, spawn_agent, GraderConfig, EvalDomain } from '../Types/index.ts';
 ...
 */
export function saveTask(task: spawn_agent, suiteName?: string): string {
  ensureDirs();
 ...
 */
export function convertAllFailures(suiteName?: string): spawn_agent[] {
