...
playwright-cli -s=demo close             # usually close
...
| `.codex/pai/agents/BrowserAgent.md` | AI-driven browser agent definition |
| `.codex/pai/agents/UIReviewer.md` | User story validation agent definition |

## Related

- [BrowserAgent](.codex/pai/agents/BrowserAgent.md)
- [UIReviewer](.codex/pai/agents/UIReviewer.md)
