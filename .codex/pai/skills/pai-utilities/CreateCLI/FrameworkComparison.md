...
## 1 TIER 1: Manual Parsing (llcli Pattern)
...
**Location:** `.codex/pai/Bin/llcli/llcli.ts` (327 lines)
**Commands:** today, date, search
**Pattern:** Exactly what this tier generates

---

## 2 TIER 2: Commander.js
...
**Sources:**
- llcli production implementation (.codex/pai/Bin/llcli/)
