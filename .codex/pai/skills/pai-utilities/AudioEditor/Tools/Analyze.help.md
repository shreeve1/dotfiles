...
LLM-powered edit classification using Codex. Reads a word-level transcript and classifies segments for cutting.

## Usage

```bash
bun .codex/pai/skills/Utilities/AudioEditor/Tools/Analyze.ts <transcript.json> [--output <path>] [--aggressive]
```
