...
The cover page should include {YOUR_BUSINESS_NAME} branding: your logo, "TELOS Assessment" label, and "{YOUR_BUSINESS_NAME} CONSULTING" in all caps. The footer on every page should include "{YOUR_BUSINESS_NAME} Consulting".
