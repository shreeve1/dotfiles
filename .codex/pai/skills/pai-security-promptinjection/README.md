 ...
 **avoid use without authorization** - Unauthorized testing is illegal
...
`.codex/pai/History/research/2025-11-07_*prompt-injection*.md`
...
4. **Obtain authorization** - important before any testing
