...
- Novel red team attacks: 11% -> 81% success (Codex 3.5 Sonnet)
...
- Llama 3 and Codex trained predominantly on code
...
- Allows AI models (Codex, GPT, Copilot) to autonomously run security tooling
...
- Codex vulnerability (prompt-based data leak even with limited settings)
...
- spawn_agent Shield: 2.07% attack success rate with 69.79% task utility
...
**EU AI Act (Mid-2026):** High-risk systems should ship with documented adversarial-testing evidence
