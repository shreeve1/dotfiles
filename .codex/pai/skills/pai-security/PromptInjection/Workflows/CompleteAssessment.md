...
- Written authorization important (verify before starting)
...
**Save to:**
```
.codex/pai/History/research/YYYY-MM-DD_[client]-recon/
...
```
.codex/pai/History/research/YYYY-MM-DD_[client]-direct-injection/
 findings.md
...
**Document findings in:**
```
.codex/pai/History/research/YYYY-MM-DD_[client]-indirect-injection/
 findings.md
 poisoned-documents/
 test-web-pages/
...
```
.codex/pai/History/research/YYYY-MM-DD_[client]-multistage/
...
**Document in:**
```
.codex/pai/History/research/YYYY-MM-DD_[client]-defenses/
...
**Deliverables:**
```
.codex/pai/History/research/YYYY-MM-DD_[client]-final-report/
