...
export const CONFIG = {
  ...
  // Local paths
  paths: {
    root: '.codex/pai/skills/hacking/bug-bounties',
    state: '.codex/pai/skills/hacking/bug-bounties/state.json',
    cache: '.codex/pai/skills/hacking/bug-bounties/cache',
    logs: '.codex/pai/skills/hacking/bug-bounties/logs',
  },
