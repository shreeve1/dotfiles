...
bun .codex/pai/skills/Security/Recon/Tools/BountyPrograms.ts list

# Show only paid bounty programs (not just swag)
bun .codex/pai/skills/Security/Recon/Tools/BountyPrograms.ts list --bounty-only

# Search for programs by keyword
bun .codex/pai/skills/Security/Recon/Tools/BountyPrograms.ts search "crypto"
bun .codex/pai/skills/Security/Recon/Tools/BountyPrograms.ts search "finance"
bun .codex/pai/skills/Security/Recon/Tools/BountyPrograms.ts search "cloud"

# Check if a domain has a bounty program
bun .codex/pai/skills/Security/Recon/Tools/BountyPrograms.ts check example.com

# Update local cache from sources
bun .codex/pai/skills/Security/Recon/Tools/BountyPrograms.ts update

# Export as JSON
bun .codex/pai/skills/Security/Recon/Tools/BountyPrograms.ts list --json > bounty-programs.json
```
...
Local cache stored at: `.codex/pai/skills/Security/Recon/Data/BountyPrograms.json`
