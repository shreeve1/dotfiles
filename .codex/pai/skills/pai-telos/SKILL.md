---
name: "pai-telos"
description: "PAI Codex port: Life OS and project analysis - goals, dependencies, beliefs, wisdom, books, movies, narrative points, interview extraction, McKinsey reports, and project dashboards. USE WHEN Telos, life goals, projects, dependencies, b..."
---
...
1. **Personal TELOS** - {PRINCIPAL.NAME}'s life context system (beliefs, goals, lessons, wisdom) at `.codex/pai/PAI/USER/TELOS/`
...
|--------------|---------|----------|
| "my TELOS", "my goals", "my beliefs", "add to TELOS" | Personal TELOS | `.codex/pai/PAI/USER/TELOS/` |
...
All files located in `.codex/pai/PAI/USER/TELOS/`:
...
```bash
# View specific file
read .codex/pai/PAI/USER/TELOS/GOALS.md
read .codex/pai/PAI/USER/TELOS/BELIEFS.md

# View recent updates
read .codex/pai/PAI/USER/TELOS/updates.md
```
...
**Launch Strategy:**
Use single message with 10 spawn_agent calls in parallel:
...
**Personal TELOS:**
- avoid commit to public repos
- avoid share publicly
...
1. **Dual Context** - Handles both personal and project TELOS seamlessly
   - Personal TELOS: `.codex/pai/PAI/USER/TELOS/` (in CORE USER directory)
...
**Remember:** Personal TELOS files live at `.codex/pai/PAI/USER/TELOS/` (in the CORE USER directory)
