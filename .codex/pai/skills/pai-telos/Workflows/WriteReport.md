...
cp -r .codex/pai/skills/Telos/ReportTemplate/* {output_dir}/
...
```
.codex/pai/skills/Telos/ReportTemplate/
```
...
- CreateNarrativePoints should run first to generate narrative content
...
Edit files in `.codex/pai/skills/Telos/ReportTemplate/components/`

**To change color scheme:**
Edit CSS custom properties in `.codex/pai/skills/Telos/ReportTemplate/app/globals.css`
