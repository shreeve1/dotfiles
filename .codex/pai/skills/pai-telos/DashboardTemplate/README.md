...
A reusable Next.js dashboard template with Tokyo Night Day theme, shadcn/ui components, and built-in AI chat functionality powered by Codex Haiku 4.5.
...
- **AI Chat**: Built-in Ask page with Codex Haiku 4.5 integration
...
2. **Ask** (`/ask`) - AI chatbot powered by Codex Haiku 4.5 with full TELOS context
...
```bash
cp -r .codex/pai/skills/telos/dashboard-template /path/to/your/project
...
The Ask page uses Codex Haiku 4.5 via Anthropic API:
...
- Searches `.codex/pai/skills/Telos/` for `.md` files
- Searches `.codex/pai/skills/Telos/data/` for `.csv` files
...
- **Icons**: Lucide React
- **AI**: Codex Haiku 4.5 (Anthropic API)
