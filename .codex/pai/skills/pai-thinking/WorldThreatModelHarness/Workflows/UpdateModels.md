...
- Model template at `.codex/pai/skills/WorldThreatModelHarness/ModelTemplate.md`
...
```
Read .codex/pai/MEMORY/RESEARCH/WorldModels/INDEX.md (if exists)
...
Save to: `.codex/pai/MEMORY/RESEARCH/WorldModels/{horizon}.md`

### Step 5: Update INDEX

Write/update `.codex/pai/MEMORY/RESEARCH/WorldModels/INDEX.md`:
...
RESEARCH: Use web search to find current data, forecasts, and analysis relevant to
...
| **web search** | Current events and projections |
