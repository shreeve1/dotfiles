...
Launch 4 parallel spawn_agent calls (one per council member).
...
Launch 4 parallel spawn_agent calls with Round 1 transcript included.
...
Launch 4 parallel spawn_agent calls with Round 1 + Round 2 transcripts.
...
| Council Role | spawn_agent subagent_type | Personality Reference |
|--------------|-------------------|----------------------|
...
| general-purpose | Custom Agent (ComposeAgent) | spawn_agent-specific |
