---
name: "pai-utilities-documents-pptx"
description: "PAI Codex port: Codex port of PAI Pptx."
---
...
- **avoid vertically stack**: Do not place charts/tables below text in a single column - this causes poor readability and layout issues

### Workflow
1. **important - READ ENTIRE FILE**: Read [`html2pptx.md`](html2pptx.md) completely from start to finish. **avoid set any range limits when reading this file.** Read the full file content for detailed syntax, critical formatting rules, and best practices before proceeding with presentation creation.
...
### Workflow
1. **important - READ ENTIRE FILE**: Read [`ooxml.md`](ooxml.md) (~500 lines) completely from start to finish.  **avoid set any range limits when reading this file.**  Read the full file content for detailed guidance on OOXML structure and editing workflows before any presentation editing.
...
1. **Extract template text AND create visual thumbnail grid**:
   ...
   * Read `template-content.md`: Read the entire file to understand the contents of the template presentation. **avoid set any range limits when reading this file.**
...
5. **Extract ALL text using the `inventory.py` script**:
   * **Run inventory extraction**:
     ...
     ```
   * **Read text-inventory.json**: Read the entire text-inventory.json file to understand all shapes and their properties. **avoid set any range limits when reading this file.**
