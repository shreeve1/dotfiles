...
- **avoid modify text inside another author's `<w:ins>` or `<w:del>` tags**
- **usually use nested deletions** to remove another author's insertions
...
**Deleting Another Author's Insertion (should use nested structure):**
```xml
