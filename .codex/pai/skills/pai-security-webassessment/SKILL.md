---
name: "pai-security-webassessment"
description: "PAI Codex port: Full web app security assessment - app understanding, threat modeling, OWASP testing, ffuf fuzzing, Playwright automation, AI-assisted vuln analysis. Coordinates with Recon and PromptInjection skills. USE WHEN web asses..."
---
...
`.codex/pai/PAI/USER/SKILLCUSTOMIZATIONS/WebAssessment/`
...
bun .codex/pai/skills/Security/Recon/Tools/CorporateStructure.ts target.com

# Subdomain enumeration
bun .codex/pai/skills/Security/Recon/Tools/SubdomainEnum.ts target.com

# Endpoint discovery from JavaScript
bun .codex/pai/skills/Security/Recon/Tools/EndpointDiscovery.ts https://target.com

# Port scanning
bun .codex/pai/skills/Security/Recon/Tools/PortScan.ts target.com

# Path discovery
bun .codex/pai/skills/Security/Recon/Tools/PathDiscovery.ts https://target.com
```
