...
import { insertNewsletterContent } from '.codex/pai/skills/parser/db';
...
- For traditional PDF extraction (text-only), see `.codex/pai/skills/documents/pdf/SKILL.md`
- For PDF form filling, see `.codex/pai/skills/documents/pdf/forms.md`
- For parser integration, see `.codex/pai/skills/parser/SKILL.md`
- For newsletter database schema, see `.codex/pai/Context/databases/newsletter/schema.sql`
