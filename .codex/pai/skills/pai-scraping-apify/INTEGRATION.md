...
**Location:** `.codex/pai/skills/social/SKILL.md`
...
2. System runs: `bun .codex/pai/filesystem-mcps/apify/get-latest-tweet.ts`
...
bun .codex/pai/filesystem-mcps/apify/get-user-tweets.ts ThePrimeagen 10

# Analyze Paul Graham's recent thoughts
bun .codex/pai/filesystem-mcps/apify/get-user-tweets.ts paulg 20

# Track Simon Willison's posts
bun .codex/pai/filesystem-mcps/apify/get-user-tweets.ts simonw 15
```
...
bun .codex/pai/filesystem-mcps/apify/get-latest-thread.ts
...
bun .codex/pai/filesystem-mcps/apify/get-latest-tweet.ts
...
### DO:
 ...
 Run from `.codex/pai/filesystem-mcps/apify/` directory or use full path
...
**For Users:**
- Quick reference: `.codex/pai/filesystem-mcps/SCRIPTS-REFERENCE.md`
- Social skill: `.codex/pai/skills/social/SKILL.md`

**For Developers:**
- Implementation: `.codex/pai/filesystem-mcps/apify/README.md`
- Standards: `.codex/pai/filesystem-mcps/STANDARDS.md`
- Parent guide: `.codex/pai/filesystem-mcps/README.md`
...
A: Check `APIFY_TOKEN` in `CODEX_PAI_ROOT/.env`, verify network, check Apify status.
