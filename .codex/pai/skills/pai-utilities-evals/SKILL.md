---
name: "pai-utilities-evals"
description: "PAI Codex port: Objective eval metrics via code/model/human graders with pass@k/pass^k scoring. USE WHEN eval, evaluate, test agent, benchmark, verify behavior, regression test, capability test, run eval, compare models, compare prompt..."
---
...
`.codex/pai/PAI/USER/SKILLCUSTOMIZATIONS/Evals/`
...
```bash
# Run an eval suite
bun run .codex/pai/skills/Utilities/Evals/Tools/AlgorithmBridge.ts -s <suite>

# Log a failure for later conversion
bun run .codex/pai/skills/Utilities/Evals/Tools/FailureToTask.ts log "description" -c category -s severity

# Convert failures to test tasks
bun run .codex/pai/skills/Utilities/Evals/Tools/FailureToTask.ts convert-all

# Manage suites
bun run .codex/pai/skills/Utilities/Evals/Tools/SuiteManager.ts create <name> -t capability -d "description"
bun run .codex/pai/skills/Utilities/Evals/Tools/SuiteManager.ts list
bun run .codex/pai/skills/Utilities/Evals/Tools/SuiteManager.ts check-saturation <name>
bun run .codex/pai/skills/Utilities/Evals/Tools/SuiteManager.ts graduate <name>
```
...
bun run .codex/pai/skills/Utilities/Evals/Tools/AlgorithmBridge.ts -s regression-core -r 3 -u
```
