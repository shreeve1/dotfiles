...
bun run .codex/pai/Templates/Tools/RenderTemplate.ts \
  -t Evals/Judge.hbs \
  -d .codex/pai/skills/Utilities/Evals/UseCases/<name>/judge-config.yaml \
  -o .codex/pai/skills/Utilities/Evals/UseCases/<name>/judge-prompt.md
```
...
bun run .codex/pai/Templates/Tools/RenderTemplate.ts \
  -t Evals/Rubric.hbs \
  -d .codex/pai/skills/Utilities/Evals/UseCases/<name>/rubric.yaml \
  -o .codex/pai/skills/Utilities/Evals/UseCases/<name>/rubric.md
```
