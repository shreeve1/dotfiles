---
name: "pai-contentanalysis-extractwisdom"
description: "PAI Codex port: Content-adaptive wisdom extraction - detects what domains exist in content and builds custom sections (not static IDEAS/QUOTES). Produces tailored insight reports from videos, podcasts, articles. USE WHEN extract wisdom..."
---
...
`.codex/pai/PAI/USER/SKILLCUSTOMIZATIONS/ExtractWisdom/`
...
- **Don't drop your best material between drafts.** If a spicy take, stunning moment, or first-time revelation was identified in an earlier pass, it should survive into the final version. Losing great material is worse than adding mediocre material.
