...
DISPATCH: "Point to files, directories, or a plan to review. Specify scope (endpoints, auth, input validation, etc.) if focused review is needed."
...
- Only write findings reports to `artifacts/docs/reference/` and navigation updates to `artifacts/docs/README.md`
