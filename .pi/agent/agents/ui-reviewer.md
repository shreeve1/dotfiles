...
2. **Prefer the bundled capture script when present** - if `$HOME/.pi/agent/skills/ui-review/scripts/capture-ui-review.js` exists, use `bash` to run it instead of rewriting browser automation each time.
