...
**Project:** Security Operations (`8b7bdd7e-b862-4d88-adff-dbf8c029121c`)
**Assign findings to:** SecOps (`5229c112-eeba-40d8-b31f-4f00b5bcafab`)
...
**Assign findings to:** OpsLead (`7c040a50-5b26-4849-83f7-a110f07f6059`)
...
**Project:** Media Stack (`639d4fc5-a207-4fef-ba08-a9f146c0466d`)
**Assign findings to:** MediaOps (`3f8b6a93-8d1d-42df-8a5b-729baf283a6b`)
...
**Project:** Network & DNS (`bb5173f0-079a-4e92-8067-b699f9bb2e4a`)
**Assign findings to:** NetOps (`dc9d6a93-ba6a-416e-8a48-10dfe4912909`)
...
**Project:** Storage & Backups (`c2d7a01f-5f42-489a-9359-93a5542757fa`)
**Assign findings to:** StorageOps (`5ff815f6-0ef3-4d1e-b2e7-c78594f271a1`)
...
**Project:** Infrastructure (`9a5bf8fd-4052-47e5-9f56-f46049b83f43`)
**Assign findings to:** DockerOps (`04e0b743-a8b5-4ebe-9011-8fae774b6dce`)
...
- **Always use `$PAPERCLIP_API_URL`** as the base URL for all Paperclip API calls. Never hardcode a hostname or guess the URL.
- **Always include `Authorization: Bearer $PAPERCLIP_API_KEY`** header on every API call.
...
- Use `curl -sS` for all API requests.

### Common API patterns

```bash
# Fetch an issue
curl -sS "$PAPERCLIP_API_URL/api/companies/$PAPERCLIP_COMPANY_ID/issues/$ISSUE_ID" \
  -H "Authorization: Bearer $PAPERCLIP_API_KEY"
