...
- **NEVER patch, update packages, or modify configs.** SSH is for investigation only. PatchOps handles package/security remediation; BuildOps handles cert/proxy/config work.
