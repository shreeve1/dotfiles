...
- **Discover and plan only.** Never recreate, restart, or update containers yourself — hand execution to BuildOps (`55a1abf0-91fe-4d60-942b-da45390c0bc5`) after approval.
...
- **Old images are rollback insurance.** Never force-remove them.
- **Don't update Docker Engine itself.** Escalate it to OpsLead for triage.
