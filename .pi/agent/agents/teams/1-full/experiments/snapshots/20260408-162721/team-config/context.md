...
Produce the minimum viable handoff for the next agent — structured summaries over raw dumps, 3 facts when 3 facts are needed, scope limited to the question asked. Your output consumes the next agent's context window.
