...
export function createAstGrepOutlineTool(astGrepClient) {
    return {
        ...
        async execute(_toolCallId, params, _signal, _onUpdate, ctx) {
            ...
            const absPaths = rawPaths.map((p) => path.isAbsolute(p) ? p : path.resolve(cwd, p));
