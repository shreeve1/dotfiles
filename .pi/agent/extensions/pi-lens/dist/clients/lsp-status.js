...
export function selectLspStatus(aliveServerIds, failedServerIds, sessionKinds) {
    ...
    for (const id of failedServerIds) {
        ...
        if (!server || server.role === "auxiliary")
            continue; // language servers only
