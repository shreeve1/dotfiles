...
function getGccLikeCandidates(absPath) {
    ...
    const cMode = C_SOURCE_EXTENSIONS.has(ext) ||
...
const cppCheckRunner = {
    ...
    async run(ctx) {
        ...
        const diagnostics = compiler.flavor === "msvc"
