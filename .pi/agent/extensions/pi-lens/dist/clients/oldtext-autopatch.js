 ...
 */
export function normalizeOldTextForMatch(text) {
 ...
 */
export function findUniqueMatchLineRange(matchNormalizedContent, oldText) {
...
export function stripTrailingWhitespaceDetailed(value) {
...
export function computeTrailingWhitespaceOldTextPatch(args) {
    ...
    if (countOccurrences(fileContentLf, stripped.text) !== 1)
        return undefined;
    const patchedNewText = args.newText !== undefined && stripped.removedTrailingEmptyLineCount > 0
