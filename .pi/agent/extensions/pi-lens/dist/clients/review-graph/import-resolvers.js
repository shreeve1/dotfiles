...
export function resolveAliasedImport(cwd, specifier, importerDir) {
...
export function resolveProjectReferenceImport(cwd, specifier, importerDir) {
 ...
 */
export function resolveWorkspacePackageImport(cwd, source) {
