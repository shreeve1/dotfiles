...
export const ADVERTISED_POSITION_ENCODINGS = [
    "utf-16",
    "utf-8",
];
/**
 ...
 */
export function negotiatePositionEncoding(serverCapabilities) {
 ...
 */
export function convertCharacterOffset(encoding, lineText, utf16Character) {
    if (encoding === "utf-16")
...
export function lineTextAt(content, line) {
    if (line < 0)
        return "";
