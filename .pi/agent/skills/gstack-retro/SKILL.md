...
```bash
DISCOVER_BIN=""
[ -x ~/.pi/agent/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=~/.pi/agent/skills/gstack/bin/gstack-global-discover
[ -z "$DISCOVER_BIN" ] && [ -x .pi/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=.pi/skills/gstack/bin/gstack-global-discover
